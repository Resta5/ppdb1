            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-13">
                    ...
                    <div class="card-header bg-info text-light">
                        Berkas
                            <a href="{{ route('berkasPeserta.create')}}" class="btn btn-primary float-right">Tambah</a>
                        </div>
</div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table" id="berkasPeserta">
                                    ...
                                    <tbody>
                                        ...
                                        <form action="{{route('berkasPeserta.destroy' ,$data->id)}}" method="post">
                                            ...
                                            <a href="{{route('berkasPeserta.edit', $data->id)}}" class="btn btn-success float-right">Edit</a>
                                ...
                                <table class="table" id="berkasPeserta">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{$data->image()}}" alt="" style="width:150px; height:150px;" alt="ftcpy_akte"></td>
                                            <td><img src="{{$data->image()}}" alt="" style="width:150px; height:150px;" alt="ftcpy_kk"></td>
                                            <td><img src="{{$data->image()}}" alt="" style="width:150px; height:150px;" alt="ftcpy_skhun"></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
